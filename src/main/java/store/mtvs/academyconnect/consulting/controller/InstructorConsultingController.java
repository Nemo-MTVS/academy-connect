...
public class InstructorConsultingController {
    ...
    @PostMapping("/consulting/undefinedreservation")
    public String handleUndefinedBooking(
            @ModelAttribute InstructorUndefinedBookingDto requestDto,
            RedirectAttributes redirectAttributes, @AuthenticationPrincipal CustomUserDetails userDetails) {
        ...
        try {
            ...
            ConsultingBooking booking = consultingBookingService.createBookingFromReservation(instructorId, requestDto);
